	...
	<div class="btn-toolbar btn-group-md" role="toolbar">
		<a href="<c:url value="/activity/new"/>">
			<button type="button" class="btn btn-success" data-rel="tooltip"
				title="Add a new unconfirmed activity">
...
<div class="row-fluid">
	<table
		...
		<tbody>
			<c:forEach var="activity" items="${allNotConfirmedActivities}">
				<tr>
					...
					<td>
						...
						<div class="btn-toolbar btn-group-sm text-center" role="toolbar">
							<a href="#" data-toggle="modal"
								...
								data-target="#deleteNotConfirmedActivityModal">
...
<div class="modal hide" id="deleteNotConfirmedActivityModal">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal">×</button>
		<h3>Delete Activity</h3>
	</div>
	<div class="modal-body">
		<p>Are you sure you want to delete this unconfirmed activity?</p>
	</div>
